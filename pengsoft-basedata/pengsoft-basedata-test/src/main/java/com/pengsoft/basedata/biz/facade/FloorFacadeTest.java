...
public class FloorFacadeTest extends BaseFacadeTest<FloorFacade> {
    ...
    @Test
    public void init() {
        roleFacade.saveEntityAdmin(Floor.class);
        authorityFacade.saveEntityAdminAuthorities(Floor.class);
    }
