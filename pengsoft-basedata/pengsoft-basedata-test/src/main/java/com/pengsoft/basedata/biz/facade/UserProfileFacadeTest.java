...
/**
 * {@link UserProfileFacade} unit test.
 *
...
public class UserProfileFacadeTest extends BaseFacadeTest<UserProfileFacade> {
    ...
    @Test
    public void init() {
        roleFacade.saveEntityAdmin(UserProfile.class);
        authorityFacade.saveEntityAdminAuthorities(UserProfile.class);
    }
