...
import com.pengsoft.security.domain.entity.OwnedTreeBean;
...
@Setter
@MappedSuperclass
public class OwnedTreeBeanExt<T extends OwnedTreeBeanExt<T>> extends OwnedTreeBean<T> implements OwnedExt {
