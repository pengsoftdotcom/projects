...
@RestController
@RequestMapping("/api/cloud-kafka")
public class CloudKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CloudKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CloudKafkaResource(KafkaProperties kafkaProperties) {
